...
children.push(H2("Calculation worksheet (all intermediate values)"));
children.push(P("Every metric is built from the columns below. |Error| is used by MAE, Error squared by RMSE, and (Real - Mean) squared by R2. The average real severity is (2.0+0.0+4.0+1.0+3.0)/5 = 2.0."));
children.push(tbl(
  ["Grid", "Real", "Pred", "Error", "|Error|", "Error^2", "(Real-2.0)^2"],
  [
    ["1", "2.0", "1.8", "+0.2", "0.2", "0.04", "0.00"],
    ["2", "0.0", "0.3", "-0.3", "0.3", "0.09", "4.00"],
    ["3", "4.0", "3.5", "+0.5", "0.5", "0.25", "4.00"],
    ["4", "1.0", "1.2", "-0.2", "0.2", "0.04", "1.00"],
    ["5", "3.0", "3.0", "0.0", "0.0", "0.00", "1.00"],
    ["SUM", "10.0", "—", "0.0", "1.2", "0.42", "10.00"],
  ],
  [1100, 1100, 1100, 1240, 1340, 1340, 2140]));
children.push(SP());

children.push(H2("MAE — Mean Absolute Error = 0.24"));
children.push(P("Formula:  MAE = ( sum of |Error| ) / n"));
children.push(P("Rule: ignore +/- signs, then average the errors."));
children.push(code([
  "Step 1 - take |Error| of each grid (from worksheet):",
  "         |+0.2| = 0.2",
  "         |-0.3| = 0.3",
  "         |+0.5| = 0.5",
  "         |-0.2| = 0.2",
  ...
  "",
  "Step 2 - add them up:",
  "         0.2 + 0.3 + 0.5 + 0.2 + 0.0 = 1.2",
  "",
  "Step 3 - divide by n = 5 grids:",
  "         MAE = 1.2 / 5 = 0.24",
]));
...
children.push(P("Formula:  RMSE = square_root( ( sum of Error^2 ) / n )"));
children.push(P("Rule: square each error (punishes big misses), average, then take the square root."));
children.push(code([
  "Step 1 - square each Error:",
  "         (+0.2)^2 = 0.04",
  "         (-0.3)^2 = 0.09",
  "         (+0.5)^2 = 0.25   <- biggest miss, blown up the most",
  "         (-0.2)^2 = 0.04",
  "         ( 0.0)^2 = 0.00",
  "",
  "Step 2 - add them up:",
  "         0.04 + 0.09 + 0.25 + 0.04 + 0.00 = 0.42",
  "",
  "Step 3 - divide by n = 5  (this value is the MSE):",
  "         MSE = 0.42 / 5 = 0.084",
  "",
  "Step 4 - take the square root (back to severity units):",
  "         RMSE = sqrt(0.084) = 0.29",
]));
...
children.push(P("Formula:  R2 = 1 - ( SS_res / SS_tot )"));
children.push(P("SS_res = how wrong the MODEL was.  SS_tot = how wrong a 'lazy guesser' is that always predicts the average (here the average real severity = 2.0)."));
children.push(code([
  "Step 1 - SS_res = sum of Error^2 (same as RMSE step 2):",
  "         SS_res = 0.42",
  "",
  "Step 2 - SS_tot = sum of (Real - average)^2,  average = 2.0:",
  "         (2.0 - 2.0)^2 = 0",
  "         (0.0 - 2.0)^2 = 4",
  "         (4.0 - 2.0)^2 = 4",
  "         (1.0 - 2.0)^2 = 1",
...
Packer.toBuffer(doc).then(buf => {
  fs.writeFileSync("Corn_Disease_AI_Documentation.docx", buf);
  console.log("Created Corn_Disease_AI_Documentation.docx");
});
